 ...
 */
package hairath.services.implementations;

import hairath.services.ClientService;
     ...
     private boolean VerifierDoublonClient(String nom_client){
        ...
        String selectionUnique="select * from client where nom=?";
         try {
             ...
             java.util.logging.Logger.getLogger(ClientServiceImp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
         }
